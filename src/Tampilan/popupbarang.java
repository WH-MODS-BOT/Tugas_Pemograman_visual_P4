...
public class popupbarang extends javax.swing.JFrame {
    ...
    brg.kd_brg = tblbrg.getValueAt(tabelPelanggan, 0).toString();
    brg.nm_brg = tblbrg.getValueAt(tabelPelanggan, 1).toString();
    brg.jenisbrg = tblbrg.getValueAt(tabelPelanggan, 2).toString();
    brg.hargabeli = tblbrg.getValueAt(tabelPelanggan, 3).toString();
    brg.hargajual = tblbrg.getValueAt(tabelPelanggan, 4).toString();
