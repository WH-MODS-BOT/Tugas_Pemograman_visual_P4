 ...
 * @author ucok
 */
public class popuppelangganan extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    public nota plgn = null;
    /**
     * Creates new form popuppelangganan
     */
    public popuppelangganan() {
        initComponents();
        datatable();
    }
    ...
    private void initComponents() {
        ...
        bcari.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        bcari.setText("CARI");
...
int tabelPelanggan = tblplgn.getSelectedRow();
    ...
    plgn.id_plgn = tblplgn.getValueAt(tabelPelanggan, 0).toString();
    plgn.nm_plgn = tblplgn.getValueAt(tabelPelanggan, 1).toString();
    plgn.jenis = tblplgn.getValueAt(tabelPelanggan, 2).toString();
    plgn.tlpn = tblplgn.getValueAt(tabelPelanggan, 3).toString();
...
protected void datatable() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popuppelangganan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popuppelangganan().setVisible(true);
            }
        });
    }
